...
<dl>
  ...
  <dd>
    <ul>
      <li>Thrown if <code>year</code> and <code>month</code> parameters results in an invalid combination.</li>
      <li>Thrown if <code>firstDayOfWeek</code> parameter is out of range of valid values (0&ndash;6).</li>
    </ul>
  </dd>
</dl>
